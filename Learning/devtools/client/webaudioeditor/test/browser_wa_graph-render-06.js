...
<head>
  ...
  <title>browser_wa_graph-render-06.js - mozsearch</title>
...
<div class="panel">
  ...
  <ul>
  <li>
  <a href="/mozilla-central/rev/01b4b3830ea3cae2e9e431019afa6391b471c6da/devtools/client/webaudioeditor/test/browser_wa_graph-render-06.js" title="Permalink" class="icon" data-update-link="true" data-link="/mozilla-central/rev/01b4b3830ea3cae2e9e431019afa6391b471c6da/devtools/client/webaudioeditor/test/browser_wa_graph-render-06.js">Permalink <span class="accel">Y</span></a>
  </li>
  <li>
  <a href="https://hg.mozilla.org/mozilla-central/log/tip/devtools/client/webaudioeditor/test/browser_wa_graph-render-06.js" title="Log" class="icon">Log <span class="accel">L</span></a>
  </li>
  <li>
  <a href="https://hg.mozilla.org/mozilla-central/raw-file/tip/devtools/client/webaudioeditor/test/browser_wa_graph-render-06.js" title="Raw" class="icon">Raw <span class="accel">R</span></a>
  </li>
  <li>
...
<div class="blame-strip c2" data-blame="13e4c858aed3c17018467dc87f898b19b8156e23#browser/devtools/webaudioeditor/test/browser_wa_graph-render-06.js#5" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
...
<div class="blame-strip c2" data-blame="13e4c858aed3c17018467dc87f898b19b8156e23#browser/devtools/webaudioeditor/test/browser_wa_graph-render-06.js#8" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
...
<div class="blame-strip c2" data-blame="13e4c858aed3c17018467dc87f898b19b8156e23#browser/devtools/webaudioeditor/test/browser_wa_graph-render-06.js#18" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
...
<div class="blame-strip c2" data-blame="f541b35939f04dc59e247c67b5aa1871fb40ddc2#browser/devtools/webaudioeditor/test/browser_wa_controller-01.js#22" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
...
<div class="blame-strip c2" data-blame="bcf6facc3c1d9edf3de911b652ad9a36a3c0a41d#%#20" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
<span id="l21" class="line-number">21
<div class="blame-strip c1" data-blame="f541b35939f04dc59e247c67b5aa1871fb40ddc2#browser/devtools/webaudioeditor/test/browser_wa_controller-01.js#23" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
<span id="l22" class="line-number">22
<div class="blame-strip c2" data-blame="13e4c858aed3c17018467dc87f898b19b8156e23#browser/devtools/webaudioeditor/test/browser_wa_graph-render-06.js#22" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
<span id="l23" class="line-number">23
<div class="blame-strip c1" data-blame="f541b35939f04dc59e247c67b5aa1871fb40ddc2#browser/devtools/webaudioeditor/test/browser_wa_controller-01.js#25" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
...
<div class="blame-strip c1" data-blame="f541b35939f04dc59e247c67b5aa1871fb40ddc2#browser/devtools/webaudioeditor/test/browser_wa_controller-01.js#27" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
      </td>
      <td class="code">
...
</code><code id="line-8" aria-labelledby="8"><span class="syn_reserved" >const</span> <span class="syn_def" data-symbols="#BUG_1141261_URL" data-i="0" >BUG_1141261_URL</span> = <span data-symbols="#EXAMPLE_URL" data-i="1" >EXAMPLE_URL</span> + <span class="syn_string" >"doc_bug_1141261.html"</span>;
...
</code><code id="line-11" aria-labelledby="11">  <span class="syn_reserved" >const</span> { <span data-symbols="7356-0" >target</span>, <span data-symbols="7356-1" >panel</span> } = await <span data-symbols="#initWebAudioEditor" data-i="3" >initWebAudioEditor</span>(<span data-symbols="#BUG_1141261_URL" data-i="4" >BUG_1141261_URL</span>);
</code><code id="line-12" aria-labelledby="12">  <span class="syn_reserved" >const</span> { <span data-symbols="7356-2" >panelWin</span> } = <span data-symbols="7356-1" >panel</span>;
</code><code id="line-13" aria-labelledby="13">  <span class="syn_reserved" >const</span> { <span data-symbols="7356-3" >gFront</span>, $, $$, <span data-symbols="7356-6" >EVENTS</span> } = <span data-symbols="7356-2" >panelWin</span>;
</code><code id="line-14" aria-labelledby="14">
</code><code id="line-15" aria-labelledby="15">  <span class="syn_reserved" >const</span> <span data-symbols="7356-7" >events</span> = <span data-symbols="#Promise" data-i="5" >Promise</span>.<span data-symbols="#all,Promise#all" data-i="6" >all</span>([
</code><code id="line-16" aria-labelledby="16">    <span data-symbols="#getN" data-i="7" >getN</span>(<span data-symbols="7356-3" >gFront</span>, <span class="syn_string" >"create-node"</span>, 3),
</code><code id="line-17" aria-labelledby="17">    <span data-symbols="#waitForGraphRendered" data-i="8" >waitForGraphRendered</span>(<span data-symbols="7356-2" >panelWin</span>, 3, 1, 0),
</code><code id="line-18" aria-labelledby="18">  ]);
</code><code id="line-19" aria-labelledby="19">  <span data-symbols="#reload" data-i="9" >reload</span>(<span data-symbols="7356-0" >target</span>);
</code><code id="line-20" aria-labelledby="20">  await <span data-symbols="7356-7" >events</span>;
</code><code id="line-21" aria-labelledby="21">
</code><code id="line-22" aria-labelledby="22">  <span data-symbols="#ok" data-i="10" >ok</span>(<span class="syn_reserved" >true</span>, <span class="syn_string" >"Graph correctly shows gain node as disconnected"</span>);
</code><code id="line-23" aria-labelledby="23">
</code><code id="line-24" aria-labelledby="24">  await <span data-symbols="#teardown" data-i="11" >teardown</span>(<span data-symbols="7356-0" >target</span>);
</code><code id="line-25" aria-labelledby="25">});
</code></pre>      </td>
    </tr>
  </tbody>
</table>
<script>var ANALYSIS_DATA = [[[],[{"pretty":"property BUG_1141261_URL","sym":"#BUG_1141261_URL"}]],[[],[{"pretty":"property EXAMPLE_URL","sym":"#EXAMPLE_URL"}]],[[],[{"pretty":"property add_task","sym":"#add_task"}]],[[{"pretty":"initWebAudioEditor","sym":"#initWebAudioEditor"}],[{"pretty":"property initWebAudioEditor","sym":"#initWebAudioEditor"}]],[[{"pretty":"BUG_1141261_URL","sym":"#BUG_1141261_URL"}],[{"pretty":"property BUG_1141261_URL","sym":"#BUG_1141261_URL"}]],[[],[{"pretty":"property Promise","sym":"#Promise"}]],[[],[{"pretty":"property all","sym":"#all"},{"pretty":"property Promise.all","sym":"Promise#all"}]],[[{"pretty":"getN","sym":"#getN"}],[{"pretty":"property getN","sym":"#getN"}]],[[{"pretty":"waitForGraphRendered","sym":"#waitForGraphRendered"}],[{"pretty":"property waitForGraphRendered","sym":"#waitForGraphRendered"}]],[[],[{"pretty":"property reload","sym":"#reload"}]],[[],[{"pretty":"property ok","sym":"#ok"}]],[[],[{"pretty":"property teardown","sym":"#teardown"}]]];</script>
    </div>
  <div id="foot" class="footer">
    This page was generated by Searchfox <span class="pretty-date" data-datetime="Wed, 13 Feb 2019 15:28:42 +0000"></span>.
  </div>
  <span id="data" data-root="/" data-search="/mozilla-central/search" data-tree="mozilla-central" data-path="devtools/client/webaudioeditor/test/browser_wa_graph-render-06.js"></span>
