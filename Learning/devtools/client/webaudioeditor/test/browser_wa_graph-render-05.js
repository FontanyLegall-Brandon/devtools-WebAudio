...
<head>
  ...
  <title>browser_wa_graph-render-05.js - mozsearch</title>
...
<div class="panel">
  ...
  <ul>
  <li>
  <a href="/mozilla-central/rev/01b4b3830ea3cae2e9e431019afa6391b471c6da/devtools/client/webaudioeditor/test/browser_wa_graph-render-05.js" title="Permalink" class="icon" data-update-link="true" data-link="/mozilla-central/rev/01b4b3830ea3cae2e9e431019afa6391b471c6da/devtools/client/webaudioeditor/test/browser_wa_graph-render-05.js">Permalink <span class="accel">Y</span></a>
  </li>
  <li>
  <a href="https://hg.mozilla.org/mozilla-central/log/tip/devtools/client/webaudioeditor/test/browser_wa_graph-render-05.js" title="Log" class="icon">Log <span class="accel">L</span></a>
  </li>
  <li>
  <a href="https://hg.mozilla.org/mozilla-central/raw-file/tip/devtools/client/webaudioeditor/test/browser_wa_graph-render-05.js" title="Raw" class="icon">Raw <span class="accel">R</span></a>
  </li>
  <li>
...
<div class="blame-strip c2" data-blame="d94b50a890eeab57e4eb4e086369c30a20efeaa4#browser/devtools/webaudioeditor/test/browser_wa_graph-render-05.js#5" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
...
<div class="blame-strip c1" data-blame="eb0a62958a65e6a58826dcfc4081a0780f3445f5#browser/devtools/webaudioeditor/test/browser_wa_graph-render-05.js#21" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
...
<div class="blame-strip c1" data-blame="eb0a62958a65e6a58826dcfc4081a0780f3445f5#browser/devtools/webaudioeditor/test/browser_wa_graph-render-05.js#23" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
<span id="l23" class="line-number">23
<div class="blame-strip c1" data-blame="eb0a62958a65e6a58826dcfc4081a0780f3445f5#browser/devtools/webaudioeditor/test/browser_wa_graph-render-05.js#24" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
...
<div class="blame-strip c1" data-blame="d94b50a890eeab57e4eb4e086369c30a20efeaa4#browser/devtools/webaudioeditor/test/browser_wa_graph-render-05.js#22" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
...
<div class="blame-strip c2" data-blame="3c0bacbcdc816623a9982b930c0638c78ab4a2c5#browser/devtools/webaudioeditor/test/browser_wa_graph-render-05.js#29" role="button" aria-label="blame" aria-expanded="false"></div>
</span>
      </td>
      <td class="code">
...
</code><code id="line-5" aria-labelledby="5"><span class="syn_comment" > * Tests to ensure that param connections trigger graph redraws</span>
...
</code><code id="line-9" aria-labelledby="9">  <span class="syn_reserved" >const</span> { <span data-symbols="7355-0" >target</span>, <span data-symbols="7355-1" >panel</span> } = await <span data-symbols="#initWebAudioEditor" data-i="1" >initWebAudioEditor</span>(<span data-symbols="#SIMPLE_CONTEXT_URL" data-i="2" >SIMPLE_CONTEXT_URL</span>);
</code><code id="line-10" aria-labelledby="10">  <span class="syn_reserved" >const</span> { <span data-symbols="7355-2" >panelWin</span> } = <span data-symbols="7355-1" >panel</span>;
</code><code id="line-11" aria-labelledby="11">  <span class="syn_reserved" >const</span> { <span data-symbols="7355-3" >gFront</span>, $, $$, <span data-symbols="7355-6" >EVENTS</span> } = <span data-symbols="7355-2" >panelWin</span>;
</code><code id="line-12" aria-labelledby="12">
</code><code id="line-13" aria-labelledby="13">  <span class="syn_reserved" >const</span> <span data-symbols="7355-7" >events</span> = <span data-symbols="#Promise" data-i="3" >Promise</span>.<span data-symbols="#all,Promise#all" data-i="4" >all</span>([
</code><code id="line-14" aria-labelledby="14">    <span data-symbols="#getN" data-i="5" >getN</span>(<span data-symbols="7355-3" >gFront</span>, <span class="syn_string" >"create-node"</span>, 3),
</code><code id="line-15" aria-labelledby="15">    <span data-symbols="#waitForGraphRendered" data-i="6" >waitForGraphRendered</span>(<span data-symbols="7355-2" >panelWin</span>, 3, 2, 0),
</code><code id="line-16" aria-labelledby="16">  ]);
</code><code id="line-17" aria-labelledby="17">  <span data-symbols="#reload" data-i="7" >reload</span>(<span data-symbols="7355-0" >target</span>);
</code><code id="line-18" aria-labelledby="18">  <span class="syn_reserved" >const</span> [<span data-symbols="7355-8" >actors</span>] = await <span data-symbols="7355-7" >events</span>;
</code><code id="line-19" aria-labelledby="19">  <span class="syn_reserved" >const</span> [<span data-symbols="7355-9" >dest</span>, <span data-symbols="7355-10" >osc</span>, <span data-symbols="7355-11" >gain</span>] = <span data-symbols="7355-8" >actors</span>;
</code><code id="line-20" aria-labelledby="20">
</code><code id="line-21" aria-labelledby="21">  await <span data-symbols="7355-10" >osc</span>.<span data-symbols="#disconnect,osc#disconnect" data-i="8" >disconnect</span>();
</code><code id="line-22" aria-labelledby="22">
</code><code id="line-23" aria-labelledby="23">  <span data-symbols="7355-10" >osc</span>.<span data-symbols="#connectParam,osc#connectParam" data-i="9" >connectParam</span>(<span data-symbols="7355-11" >gain</span>, <span class="syn_string" >"gain"</span>);
</code><code id="line-24" aria-labelledby="24">  await <span data-symbols="#waitForGraphRendered" data-i="10" >waitForGraphRendered</span>(<span data-symbols="7355-2" >panelWin</span>, 3, 1, 1);
</code><code id="line-25" aria-labelledby="25">  <span data-symbols="#ok" data-i="11" >ok</span>(<span class="syn_reserved" >true</span>, <span class="syn_string" >"Graph re-rendered upon param connection"</span>);
</code><code id="line-26" aria-labelledby="26">
</code><code id="line-27" aria-labelledby="27">  await <span data-symbols="#teardown" data-i="12" >teardown</span>(<span data-symbols="7355-0" >target</span>);
</code><code id="line-28" aria-labelledby="28">});
</code></pre>      </td>
    </tr>
  </tbody>
</table>
<script>var ANALYSIS_DATA = [[[],[{"pretty":"property add_task","sym":"#add_task"}]],[[{"pretty":"initWebAudioEditor","sym":"#initWebAudioEditor"}],[{"pretty":"property initWebAudioEditor","sym":"#initWebAudioEditor"}]],[[{"pretty":"SIMPLE_CONTEXT_URL","sym":"#SIMPLE_CONTEXT_URL"}],[{"pretty":"property SIMPLE_CONTEXT_URL","sym":"#SIMPLE_CONTEXT_URL"}]],[[],[{"pretty":"property Promise","sym":"#Promise"}]],[[],[{"pretty":"property all","sym":"#all"},{"pretty":"property Promise.all","sym":"Promise#all"}]],[[{"pretty":"getN","sym":"#getN"}],[{"pretty":"property getN","sym":"#getN"}]],[[{"pretty":"waitForGraphRendered","sym":"#waitForGraphRendered"}],[{"pretty":"property waitForGraphRendered","sym":"#waitForGraphRendered"}]],[[],[{"pretty":"property reload","sym":"#reload"}]],[[],[{"pretty":"property disconnect","sym":"#disconnect"},{"pretty":"property osc.disconnect","sym":"osc#disconnect"}]],[[],[{"pretty":"property connectParam","sym":"#connectParam"},{"pretty":"property osc.connectParam","sym":"osc#connectParam"}]],[[{"pretty":"waitForGraphRendered","sym":"#waitForGraphRendered"}],[{"pretty":"property waitForGraphRendered","sym":"#waitForGraphRendered"}]],[[],[{"pretty":"property ok","sym":"#ok"}]],[[],[{"pretty":"property teardown","sym":"#teardown"}]]];</script>
    </div>
  <div id="foot" class="footer">
    This page was generated by Searchfox <span class="pretty-date" data-datetime="Wed, 13 Feb 2019 15:28:42 +0000"></span>.
  </div>
  <span id="data" data-root="/" data-search="/mozilla-central/search" data-tree="mozilla-central" data-path="devtools/client/webaudioeditor/test/browser_wa_graph-render-05.js"></span>
